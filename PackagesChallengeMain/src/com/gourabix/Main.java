...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Sum of the first 10 numbers = " + Series.nSum(10));
        System.out.println("Factorial (looped) of 4 = " + Series.factorialLoop(4));
        System.out.println("Factorial (recursive) of 5 = " + Series.factorialRecursive(5));
        System.out.println("The 6th fibonacci term = " + Series.fibonacci(6));
        ...
        for (int i = 0; i <= 10; i++) {
            System.out.println(Series.factorialLoop(i));
        }
