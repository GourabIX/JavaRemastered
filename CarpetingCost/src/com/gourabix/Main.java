...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Carpet carpet1 = new Carpet(12.26);
        Floor floor1 = new Floor(65.0, 125.68);
        Calculator calculator1 = new Calculator(floor1, carpet1);
        System.out.println("Cost of covering a floor of area: " + floor1.getArea() + " with a carpet that costs " +
                carpet1.getCost() + " is equal to " + calculator1.getTotalCost() + " INR.");
    }
}
