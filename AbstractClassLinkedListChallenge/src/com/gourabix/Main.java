...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String city : cities) {
            nodeList.addNode(new Node(city));
        }
        ...
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode(new Node("3"));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("5")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("0")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("4")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("2")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("12")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("9")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("8")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("6")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode((new Node("1")));
        nodeList.traverse(nodeList.getNodeListRoot());
        nodeList.removeNode(nodeList.getNodeListRoot());
        nodeList.traverse(nodeList.getNodeListRoot());
        System.out.println();
